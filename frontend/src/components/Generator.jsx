...
// Workout goals
const workoutGoals = [
    { id: 'strength', name: 'Strength & Power', icon: <FaDumbbell />, description: 'Low reps for building maximal strength' },
    { id: 'hypertrophy', name: 'Growth & Hypertrophy', icon: <BiTargetLock />, description: 'Moderate reps for muscle growth' },
    { id: 'endurance', name: 'Endurance', icon: <FaHeartbeat />, description: 'High reps for muscle endurance' }
];
...
const Generator = ({ isDarkMode }) => {
    ...
    const handleGenerateWorkout = async () => {
        ...
        try {
            ...
            if (success) {
                toastSuccess('Workout generated successfully!');
                ...
                toastError(error || 'Failed to generate workout. Please try different selections.');
